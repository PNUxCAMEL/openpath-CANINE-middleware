...
static bool generate_nrt_thread(pthread_t &thread_nrt, void* (*thread_func)(void *), const char* name, int cpu_no, void *arg){
    pthread_attr_t attr;
    cpu_set_t cpuset;
    int ret;
...
static bool generate_rt_thread(pthread_t &thread_rt, void* (*thread_func)(void *), const char* name, int cpu_no, int priority, void *arg){
...
static bool generate_rt_thread_hard(pthread_t &thread_rt, void* (*thread_func)(void *), const char* name, int cpu_no, int priority, void *arg){
    struct sched_param param;
    pthread_attr_t attr;
    cpu_set_t cpuset;
    int ret;
